...
| 开发工具 | 代码截图（highlight.js 语法高亮 + 2× PNG 导出）· `.env` 编辑器             | 纯前端  |
| 网络工具 | IP 查询 / 域名解析（DoH + IP 归属地）· HTTP 状态码 / 常用端口速查 · UTM 链接生成 | 联网/纯前端 |
| 生成工具 | 条形码生成（CODE128 / EAN / UPC）                                   | 纯前端  |
...
- 白板与流程图使用的 Excalidraw — MIT；在线表格使用的 Univer 核心 — Apache-2.0；思维导图使用的 Mind Elixir — MIT（第三方归属见 [`web/THIRD-PARTY-NOTICES.md`](web/THIRD-PARTY-NOTICES.md)）
